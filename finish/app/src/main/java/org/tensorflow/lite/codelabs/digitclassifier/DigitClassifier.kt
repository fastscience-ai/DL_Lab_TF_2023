...
/** SOO: Library to accept tensorflow lite model **/
// TODO
...
class DigitClassifier(private val context: Context) {
  ...
  // Initialize Interpreter (tensorflow lite placeholder)
  ...
  // Take the input of the screenshot and inference with interpreter
